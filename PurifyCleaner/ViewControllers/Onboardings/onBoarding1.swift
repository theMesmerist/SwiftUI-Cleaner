...
class onBoarding1: UIViewController {
    ...
    func setupUI() {
        ...
        sliderImg.image = UIImage(named: "img_slider01")
        ...
        titleLbl.text = "Hide Your Private\nMedia"
        ...
        descLbl.text = "Import your private photos into the app and save them in your private album within the app by specifying a password."
